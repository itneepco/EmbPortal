...
public class UserService : IUserService
{
    ...
    public async Task<IResult> ResetSelfPassword(string userId, ChangePasswordRequest request)
    {
        var response = await _httpClient.PostAsJsonAsync($"/api/Identity/{userId}/Reset", request);
        return await response.ToResult();
    }
