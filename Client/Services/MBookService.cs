...
public class MBookService : IMBookService
{
    ...
    public async Task<List<WorkOrderItemStatusResponse>> GetCurrentMBItemsStatus(int id)
    {
        return await _httpClient.GetFromJsonAsync<List<WorkOrderItemStatusResponse>>($"/api/MBook/{id}/ItemStatus");
    }
